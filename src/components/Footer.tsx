    ...
    <footer className="bg-background">
      ...
      <div className="container mx-auto px-4 pt-12">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <h3 className="font-display text-[28px] font-semibold text-foreground">Stay up to date</h3>
          <h3 className="font-display text-[28px] font-semibold text-foreground">Get social</h3>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-14">
        <div className="grid md:grid-cols-3 gap-12">
          ...
          <div className="text-center">
            <h4 className="font-display text-base font-semibold uppercase text-muted-foreground mb-6">Quick Links</h4>
          ...
          {/* Event Partners */}
          <div className="text-center">
            <h4 className="font-display text-base font-semibold uppercase text-muted-foreground mb-6">Event Partners</h4>
          ...
          <div className="text-center">
            <h4 className="font-display text-base font-semibold uppercase text-muted-foreground mb-6">Acknowledgement of Country</h4>
