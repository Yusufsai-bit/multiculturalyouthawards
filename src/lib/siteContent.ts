 ...
 nominationsCloseDate: '31 August 2026',
  ...
  winners2024: {
    'Young Influencer of the Year': {
      ...
      finalists: [{ name: 'Nhat Minh Hoang', bio: 'Minh is mobilising young people to tackle ethical and social issues in the tech sector through systemic advocacy. Recently, they engaged youth across Australia for insights on the \'Statutory Review of the Online Safety Act\', alongside a social media campaign. Minh also organised \'In Dialogue: Online Freedom or Safety\', empowering queer youth to co-design social media policies for Big Tech leaders, including the UN. As a member of the eSafety Commissioner\u2019s Youth Council, Minh has contributed to consultations with parliament and presented to over 150 public servants.' }],
    },
    'Inspirational Young Person of the Year': {
      name: 'Lutfiye Kavci',
    ...
    'Volunteer of the Year': {
      ...
      finalists: [{ name: 'William Yin', bio: 'William is a dedicated young volunteer whose community service includes filming, video editing, and creating bilingual subtitles for online concerts, enhancing inclusivity through English and Chinese subtitles. After the pandemic, he distributed promotional materials, hand sanitiser, and masks to support the multicultural community. His commitment reflects a desire to strengthen community bonds and foster a positive environment for diverse backgrounds. With a strong sense of responsibility, William is eager to continue using his multimedia skills to promote cultural exchange and unity.' }],
    },
    'Young Leader of the Year': {
      name: 'Daisy Wu',
      ...
      finalists: [{ name: 'Mamuch Chuol', bio: 'Mamuch Chuol is a youth advocate and founder of NextGen Unite, empowering South Sudanese Australians and multicultural communities through sport, education, and mentorship. As a youth worker at the Centre for Multicultural Youth, Mamuch supports migrant youth while pursuing a double degree in Law and Arts at Victoria University.' }, { name: 'Tony Luo', bio: 'Tony is a Sustainability Strategist at Sustainability Victoria, focused on sustainability policy and urban planning. A winner of the City of Melbourne Urban Forest Design Competition, he supports sustainable urban development. With a Bachelor of Environments, he is a United Nations Local Pathways Fellow for SDG11.' }],
    },
    'Young Woman of the Year': {
      name: 'Sarah Hanoona',
      ...
      finalists: [{ name: 'Aayushi Khillan', bio: 'Aayushi Khillan, a 24-year-old medical student, is the CEO and Founder of Body Buddies, a social enterprise promoting health education through organ-shaped toys. Since launching, she has raised over $140,000 for charity, donating 50% of profits to Transplant Australia. Aayushi also serves on the Victorian Curriculum and Assessment Authority.' }, { name: 'Daisy Truong', bio: 'Daisy Truong works diligently in the multicultural affairs space alongside the Minister for Multicultural Affairs, Ingrid Stitt MP. Her efforts extend to the VPS Women of Colour Network, where she has tirelessly advocated for anti-racism strategies and empowerment, striving to create a more inclusive and equitable environment for all.' }],
    },
    'Young Apprentice or Vocational Award': {
      name: 'Eizar Bee',
    ...
    'Implementing Aboriginal Self Determination Award': {
      ...
      finalists: [{ name: 'Lashay Blurton', bio: 'Lashay Blurton embodies leadership and resilience. Starting as a participant in the Karreeta Koornong Maar Youth Program, she evolved into a mentor, encouraging cultural identity. As a Budj Bim Ranger, she focuses on land management and cultural preservation, inspiring young people and amplifying their voices.' }],
    },
    'Academic Excellence Award': {
      name: 'Arya Sadeghi',
    ...
    'Sportsperson of the Year': {
      ...
      finalists: [{ name: 'Nabeera Khan', bio: 'Growing up in the NSW outback, Nabeera excelled in public speaking and sports. After moving to Victoria, she embraced Taekwondo and kickboxing, participating in high school debates and leadership roles. Now studying Criminology and Psychological Science at La Trobe University, Nabeera also works as a Taekwondo and kickboxing instructor. She aims to inspire multicultural youth to break barriers and make a positive community impact, believing in growth academically, athletically, and spiritually.' }],
    },
    'Creative and Performing Arts Award': {
      name: 'Celine Khoury',
      ...
      finalists: [{ name: 'Lakshmi Ganapathy', bio: 'Lakshmi Ganapathy is a graduate of La Trobe University\'s Bachelor of Creative Arts (Theatre and Media Studies) and a dedicated journalist and theatre-maker focused on voicing overlooked perspectives and democratising theatre. She gained recognition for her role as Kattrin in Damien Millar\u2019s production of Mother Courage and Her Children (La Mama, 2021) and as the Melbourne Content Creator for Indian Link, an award-winning publication for the South Asian diaspora. Lakshmi, the first in her family to pursue an arts career, passionately campaigned against her university\'s closure of the Creative Arts degree and Student Theatre program during the 2020 education cuts. Selected for the inaugural La Mama Emerge program, she directed a site-specific production of DNA by Dennis Kelly in April 2024, engaging thirty young locals through her company, Mucky Puppy Theatre.' }],
    },
    'Entrepreneur of the Year': {
      name: 'Sagalee Omer',
      ...
      finalists: [{ name: 'Ejaz Hussain', bio: 'Ejaz, a 21-year-old Afghan refugee, founded Saheel Film at 19, offering sought-after photography and videography services for the Australian-Afghan community. His work captures cultural traditions across multiple states. Despite challenges as a young entrepreneur and refugee, Ejaz built Saheel Film into a leading business, collaborating with organisations like the Centre for Multicultural Youth. He aims to expand his business, inspiring young entrepreneurs and enriching his community through storytelling and cultural celebration.' }],
    },
    'Australian Youth Minister Award': {
      name: 'Sagalee Omer',
